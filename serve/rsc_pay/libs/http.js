...
exports.sendTradeServer = function (data,url, cb) {
    if (!cb) {
        cb = function () {
        };
    }
    request({
        body: querystring.stringify({token: jwt.sign(data, config_common.secret_keys.trade, {expiresIn: config_common.token_server_timeout})}),
